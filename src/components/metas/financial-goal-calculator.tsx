...
const ResultCard = ({ label, value, icon: Icon, iconColor }: { label: string, value: string, icon: React.ElementType, iconColor?: string }) => (
    <Card className="text-center p-4 bg-secondary">
        <dt className="font-bold text-foreground flex items-center justify-center gap-2">
            <Icon className={`w-4 h-4 ${iconColor}`}/>
            <span className="text-foreground font-bold">{label}</span>
        </dt>
        <dd className="text-2xl font-bold text-background">{value}</dd>
    </Card>
);
        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="space-y-2">
                    <Label htmlFor="goalAmount" className="font-bold text-background">Qual o seu objetivo (R$)?</Label>
                ...
                <div className="space-y-2">
                    <Label htmlFor="hourlyRate" className="font-bold text-background flex items-center gap-2"><DollarSign className="w-4 h-4 text-green-500"/>Seu ganho médio por hora (R$)</Label>
                     <div className="relative">
                 ...
                 <div className="space-y-2">
                    <Label htmlFor="hoursPerDay" className="font-bold text-background">Horas de trabalho por dia</Label>
                     <div className="relative">
