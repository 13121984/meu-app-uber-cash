...
export const allStats = [
    { id: 'lucro', title: "Lucro Líquido", value: 123.45, icon: DollarSign, isCurrency: true, iconBg: "bg-chart-1", iconColor: "text-white", precision: 2 },
    ...
    { id: 'combustivel', title: "Combustível", value: 56.78, icon: Fuel, isCurrency: true, iconBg: "bg-chart-2", iconColor: "text-white", precision: 2 },
